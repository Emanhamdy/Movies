...
public class movieDetailFragment extends Fragment {
    ...
    class fetchVideoTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            String urlStr = "http://api.themoviedb.org/3/movie/" + params[0] + "/videos?api_key=ac30603525374a4ddd9688853643ae6d";
    ...
    class fetchReviewTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            HttpURLConnection urlConnection = null;
            BufferedReader reader = null;
            String urlStr = "http://api.themoviedb.org/3/movie/" + params[0] + "/reviews?api_key=ac30603525374a4ddd9688853643ae6d";
